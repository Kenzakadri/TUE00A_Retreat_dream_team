...
co#### Histograms of total scores with clinical cutoffs highlighted ####
...
myFactors=myScores
#myFactors=dplyr::rename(myFactors,DeprAnx=GLS1,Compulsivity=GLS2, SocialAnx=GLS3, Apathy=GLS4) 
